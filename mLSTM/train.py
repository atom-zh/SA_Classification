...
# 训练验证数据地址
from conf.path_config import path_train, path_valid, path_tests
# 数据预处理, 删除文件目录下文件
...
from data_preprocess.utils import mkdir, draw_accuracy_figure, copy_file
# 模型图
from mLSTM.graph import LSTMGraph as Graph
# 模型评估
