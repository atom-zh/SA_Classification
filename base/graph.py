...
from conf.path_config import path_model, path_fineture, path_model_dir, path_hyper_parameters, path_out
from data_preprocess.generator_preprocess import PreprocessGenerator, PreprocessSimGenerator
from data_preprocess.text_preprocess import save_json
from keras_layers.keras_lookahead import Lookahead
from keras.callbacks import ModelCheckpoint, EarlyStopping, TensorBoard
from keras_layers.keras_radam import RAdam
...
class graph:
    ...
    def create_model(self, hyper_parameters):
        ...
        if self.embedding_type == 'random':
            from base.embedding import RandomEmbedding as Embeddings
        elif self.embedding_type == 'bert':
            from base.embedding import BertEmbedding as Embeddings
        elif self.embedding_type == 'xlnet':
            from base.embedding import XlnetEmbedding as Embeddings
        elif self.embedding_type == 'albert':
            from base.embedding import AlbertEmbedding as Embeddings
        elif self.embedding_type == 'word2vec':
            from base.embedding import WordEmbedding as Embeddings
        else:
